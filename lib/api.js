 ...
 * opts:{depth(默认8), maxClass(默认2), out 排除区域, vp 视口过滤(默认true,只对视口内元素建树,false=全部)}。
 */
async function tree(target, selector, opts = {}) {
  const r = await evaluate(target, buildTreeExpr(selector, opts.depth, opts.maxClass, opts.out, opts.vp), 30000);

...
const { SNAPSHOT_JS, VIEW_JS, REGIONS_JS, buildTreeExpr, CLICK_JS, FILL_JS, FOCUS_JS, GET_FOCUS_JS, OUTLINE_JS, CONTENT_JS } = require('./scripts');
...
async function tree(target, selector, opts = {}) {
  const r = await evaluate(target, buildTreeExpr(selector, opts.depth, opts.maxClass, opts.out, opts.vp, opts.vm), 30000);

...
const { SNAPSHOT_JS, VIEW_JS, CLICK_JS, FILL_JS, FOCUS_JS, GET_FOCUS_JS, OUTLINE_JS, CONTENT_JS } = require('./scripts');
...
const coreApi = {
  ...
  snapshot, view, click, fill, waitFor, waitForFn, shot, focus, getFocus, outline, content, pressKey, hover,
};
